...
//    protected GPNode fullNode(final EvolutionState state,
    public GPNode fullNode(final EvolutionState state,
        final int current,
        final int max,
        final GPType type,
        final int thread,
...
//    protected GPNode growNode(final EvolutionState state,
    ...
    public GPNode growNode(final EvolutionState state,
            final int current,
            final int max,
            final GPType type,
            final int thread,
            ...
            final GPFunctionSet set) 
            {
    		return growNodeNonTerminals(state, current, max, type, thread, parent, argposition, set, false);
            }
    
    
    public GPNode growNodeNonTerminals(final EvolutionState state,
        final int current,
        final int max,
        final GPType type,
        final int thread,
