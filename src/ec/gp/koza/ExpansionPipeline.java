...
public class ExpansionPipeline extends GPBreedingPipeline {

	private static final long serialVersionUID = 1L;
	
	public static final String P_EXPANSION = "expansion";
	public static final int NUM_SOURCES = 1;

	@Override
	public Parameter defaultBase() { return GPKozaDefaults.base().push(P_EXPANSION); }
